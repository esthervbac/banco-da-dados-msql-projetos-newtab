...
#Criar a tabela "cartao" com os seguintes campos: (Id, Número, Cvv, Data de Expiração, Valido, Data de Cadastro):
...
INSERT INTO
    usuario (Nome, Imagem, Nome_de_Usuario, Data_de_Cadastro)
VALUES
    (
        'Maria Joana Alencar',
        'img-joana.jpg',
...
# Criar uma query que insira um cartão com os campos número, cvv, data de expiração, Valido e data de cadastro:
INSERT INTO
    cartao (
        Numero,
        CVV,
...
# Criar uma query que retorne apenas os cartões Validos em ordem crescente da data de cadastro:
SELECT
    *
from
    cartao
...
SELECT
    ...
    usuario.Data_de_Cadastro,
    cartao.Numero,
    cartao.CVV,
    cartao.Data_de_Expiracao,
    cartao.Valido,
    cartao.Data_de_Cadastro
FROM
    transacao
